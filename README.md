...
- [x] **Step 9A: Configure XGBoost**
  ...
  - [x] Subsample: 80%
  - [x] Feature sample: 70%
- [ ] **Step 10A: Tune XGBoost Hyperparameters**
  - [ ] Designate early windows (first 15-20) exclusively for tuning
  ...
  - [ ] Document tuning results and configuration rationale
...
- [ ] **Step 10B: Tune Linear Models**
  ...
  - [ ] Optimize alpha parameters for Ridge and LASSO
  - [ ] Select best linear model variant for each factor
- [ ] **Step 11B: Train Linear Models**
  - [ ] Train 106 factor-specific models of each type
  - [ ] Use same 14-feature sets as XGBoost
  - [ ] Validate on 6-month period
